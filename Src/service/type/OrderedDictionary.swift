...
//    }
    ...
    public func sorted(by areInIncreasingOrder: (Element, Element) throws -> Bool) rethrows -> OrderedDictionary<Key, Value> {
        OrderedDictionary(uniqueKeysWithValues: try _sortedElements(by: areInIncreasingOrder))
    }

    private func _sortedElements(by areInIncreasingOrder: (Element, Element) throws -> Bool) rethrows -> [Element] {
        try sorted(by: areInIncreasingOrder)
    }
...
extension Dictionary {
    ...
    public func sorted(by areInIncreasingOrder: (Element, Element) throws -> Bool) rethrows -> OrderedDictionary<Key, Value> {
        try OrderedDictionary(unsorted: self,
