...
def main(argv):
    ...
    number_licenses_found = len(plist['PreferenceSpecifiers'])
    if(number_licenses_found == 0):
        print "Error: No licenses found. I assume that something is not working..."
        sys.exit(2)
    else:
        print "Found {0} licenses!".format(str(number_licenses_found))
